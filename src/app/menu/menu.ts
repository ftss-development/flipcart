            ...
            children: [
              {
                id: 'country',
                title: 'Country',
                translate: 'MENU.PAGES.PLACES.COUNTRY',
                type: 'item',
                url: 'pages/places/country',
                openInNewTab: false
              },
              {
                id: 'state',
                title: 'State',
                translate: 'MENU.PAGES.PLACES.STATE',
                type: 'item',
                url: 'pages/places/state',
                openInNewTab: false
              },              
              {
                id: 'city',
                title: 'City',
                translate: 'MENU.PAGES.PLACES.CITY',
                type: 'item',
                url: 'pages/places/city',
                openInNewTab: false
              }
            ]
          },          
